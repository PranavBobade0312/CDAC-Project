        ...
        <div className="mt-3 dp-order-container">
            ...
            <div className="row mt-3">
                ...
                { props.markPickupComplete &&
                    <button className="btn btn-danger ml-3 mt-3" onClick={ () => props.markPickupComplete(props.orderId) }>Mark Pickup Complete</button>
                }
                { props.markDeliveryComplete &&
                    <button className="btn btn-danger ml-3 mt-3" onClick={ () => props.markDeliveryComplete(props.orderId) }>Mark Delivery Complete</button>
                }
            </div>
        </div>
