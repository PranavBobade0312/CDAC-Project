        ...
        <div>
            ...
            {(sessionStorage["foodItemMap"] === null) || (sessionStorage["foodItemMap"] === undefined) || (sessionStorage["foodItemMap"] === "[]") ? 
                <div className="mt-4">
                    ...
                    <Link to="/customer/home"><button className="btn btn-danger mt-3">Browse restaurants</button></Link>
                </div> :
                ...
                <div>
                    ...
                    <button className="btn btn-danger float-right" onClick={() => {navigate("/customer/address")}}>Next</button>
                </div>
            }
        </div>
    )
