                ...
                <div className="col">
                    <div className="form">
                        ...
                        <div className="d-flex justify-content-between">
                            <div className="mb-3">
                               <button className="btn btn-outline-danger" onClick={() => {navigate("/manager/restaurantmenu")}}>Cancel</button>
                            </div>
                            <div className="mb-3 float-right">
                               <button className="btn btn-danger" onClick={() => {updateFoodItem()}}>Update</button>
                            </div>
                        </div>
